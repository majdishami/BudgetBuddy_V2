...
function mergeQueries(queries) {
  ...
  for (const query of queries) {
    ...
    if ((_a163 = query.typings) == null ? void 0 : _a163.length) {
      if (!result.typings) {
        result.typings = [];
      }
  ...
  buildQueryFromSourceParams(chunks, _config) {
    ...
    return mergeQueries(chunks.map((chunk) => {
      ...
      if (isSQLWrapper(chunk)) {
        if ((_a163 = chunk.shouldOmitSQLParens) == null ? void 0 : _a163.call(chunk)) {
...
((SQL2) => {
  ...
  __publicField(_Aliased, _a163, "SQL.Aliased");
...
var _a75, _b55;
var PgNumericNumberBuilder = class extends (_b55 = PgColumnBuilder, _a75 = entityKind, _b55) {
  constructor(name, precision, scale) {
...
var _a76, _b56;
var PgNumericNumber = class extends (_b56 = PgColumn, _a76 = entityKind, _b56) {
  constructor(table, config) {
    super(table, config);
    __publicField(this, "precision");
    __publicField(this, "scale");
...
var _a77, _b57;
var PgNumericBigIntBuilder = class extends (_b57 = PgColumnBuilder, _a77 = entityKind, _b57) {
  constructor(name, precision, scale) {
...
var _a78, _b58;
var PgNumericBigInt = class extends (_b58 = PgColumn, _a78 = entityKind, _b58) {
  constructor(table, config) {
    super(table, config);
    __publicField(this, "precision");
    __publicField(this, "scale");
...
var _a79, _b59;
var PgPointTupleBuilder = class extends (_b59 = PgColumnBuilder, _a79 = entityKind, _b59) {
  constructor(name) {
...
var _a80, _b60;
var PgPointTuple = class extends (_b60 = PgColumn, _a80 = entityKind, _b60) {
  getSQLType() {
    return "point";
  }
  mapFromDriverValue(value) {
...
var _a81, _b61;
var PgPointObjectBuilder = class extends (_b61 = PgColumnBuilder, _a81 = entityKind, _b61) {
  constructor(name) {
...
var _a82, _b62;
var PgPointObject = class extends (_b62 = PgColumn, _a82 = entityKind, _b62) {
  getSQLType() {
    return "point";
  }
  mapFromDriverValue(value) {
...
var _a83, _b63;
var PgGeometryBuilder = class extends (_b63 = PgColumnBuilder, _a83 = entityKind, _b63) {
  constructor(name) {
...
var _a84, _b64;
var PgGeometry = class extends (_b64 = PgColumn, _a84 = entityKind, _b64) {
  getSQLType() {
...
var _a85, _b65;
var PgGeometryObjectBuilder = class extends (_b65 = PgColumnBuilder, _a85 = entityKind, _b65) {
  constructor(name) {
...
var _a86, _b66;
var PgGeometryObject = class extends (_b66 = PgColumn, _a86 = entityKind, _b66) {
  getSQLType() {
    return "geometry(point)";
  }
  mapFromDriverValue(value) {
...
var _a87, _b67;
var PgRealBuilder = class extends (_b67 = PgColumnBuilder, _a87 = entityKind, _b67) {
...
var _a88, _b68;
var PgReal = class extends (_b68 = PgColumn, _a88 = entityKind, _b68) {
  constructor(table, config) {
    super(table, config);
...
var _a89, _b69;
var PgSerialBuilder = class extends (_b69 = PgColumnBuilder, _a89 = entityKind, _b69) {
  constructor(name) {
...
var _a90, _b70;
var PgSerial = class extends (_b70 = PgColumn, _a90 = entityKind, _b70) {
  getSQLType() {
    return "serial";
  }
};
...
var _a91, _b71;
var PgSmallIntBuilder = class extends (_b71 = PgIntColumnBaseBuilder, _a91 = entityKind, _b71) {
  constructor(name) {
...
var _a92, _b72;
var PgSmallInt = class extends (_b72 = PgColumn, _a92 = entityKind, _b72) {
  constructor() {
    super(...arguments);
    __publicField(this, "mapFromDriverValue", (value) => {
      if (typeof value === "string") {
...
var _a93, _b73;
var PgSmallSerialBuilder = class extends (_b73 = PgColumnBuilder, _a93 = entityKind, _b73) {
  constructor(name) {
...
var _a94, _b74;
var PgSmallSerial = class extends (_b74 = PgColumn, _a94 = entityKind, _b74) {
  getSQLType() {
    return "smallserial";
  }
};
...
var _a95, _b75;
var PgTextBuilder = class extends (_b75 = PgColumnBuilder, _a95 = entityKind, _b75) {
  constructor(name, config) {
...
var _a96, _b76;
var PgText = class extends (_b76 = PgColumn, _a96 = entityKind, _b76) {
  constructor() {
    super(...arguments);
    __publicField(this, "enumValues", this.config.enumValues);
  }
...
var _a97, _b77;
var PgTimeBuilder = class extends (_b77 = PgDateColumnBaseBuilder, _a97 = entityKind, _b77) {
...
var _a98, _b78;
var PgTime = class extends (_b78 = PgColumn, _a98 = entityKind, _b78) {
  constructor(table, config) {
    super(table, config);
...
var _a99, _b79;
var PgTimestampBuilder = class extends (_b79 = PgDateColumnBaseBuilder, _a99 = entityKind, _b79) {
  constructor(name, withTimezone, precision) {
...
var _a100, _b80;
var PgTimestamp = class extends (_b80 = PgColumn, _a100 = entityKind, _b80) {
  constructor(table, config) {
    super(table, config);
    __publicField(this, "withTimezone");
    __publicField(this, "precision");
...
var _a101, _b81;
var PgTimestampStringBuilder = class extends (_b81 = PgDateColumnBaseBuilder, _a101 = entityKind, _b81) {
  constructor(name, withTimezone, precision) {
...
var _a102, _b82;
var PgTimestampString = class extends (_b82 = PgColumn, _a102 = entityKind, _b82) {
  constructor(table, config) {
    super(table, config);
    __publicField(this, "withTimezone");
    __publicField(this, "precision");
...
var _a103, _b83;
var PgUUIDBuilder = class extends (_b83 = PgColumnBuilder, _a103 = entityKind, _b83) {
  constructor(name) {
...
var _a104, _b84;
var PgUUID = class extends (_b84 = PgColumn, _a104 = entityKind, _b84) {
  getSQLType() {
    return "uuid";
  }
};
...
var _a105, _b85;
var PgVarcharBuilder = class extends (_b85 = PgColumnBuilder, _a105 = entityKind, _b85) {
  constructor(name, config) {
...
var _a106, _b86;
var PgVarchar = class extends (_b86 = PgColumn, _a106 = entityKind, _b86) {
  constructor() {
    super(...arguments);
    __publicField(this, "length", this.config.length);
    __publicField(this, "enumValues", this.config.enumValues);
...
var _a107, _b87;
var PgBinaryVectorBuilder = class extends (_b87 = PgColumnBuilder, _a107 = entityKind, _b87) {
  constructor(name, config) {
...
var _a108, _b88;
var PgBinaryVector = class extends (_b88 = PgColumn, _a108 = entityKind, _b88) {
  constructor() {
    super(...arguments);
...
var _a109, _b89;
var PgHalfVectorBuilder = class extends (_b89 = PgColumnBuilder, _a109 = entityKind, _b89) {
  constructor(name, config) {
...
var _a110, _b90;
var PgHalfVector = class extends (_b90 = PgColumn, _a110 = entityKind, _b90) {
  constructor() {
    super(...arguments);
    __publicField(this, "dimensions", this.config.dimensions);
  }
...
var _a111, _b91;
var PgSparseVectorBuilder = class extends (_b91 = PgColumnBuilder, _a111 = entityKind, _b91) {
  constructor(name, config) {
...
var _a112, _b92;
var PgSparseVector = class extends (_b92 = PgColumn, _a112 = entityKind, _b92) {
  constructor() {
    super(...arguments);
    __publicField(this, "dimensions", this.config.dimensions);
  }
...
var _a113, _b93;
var PgVectorBuilder = class extends (_b93 = PgColumnBuilder, _a113 = entityKind, _b93) {
  constructor(name, config) {
...
var _a114, _b94;
var PgVector = class extends (_b94 = PgColumn, _a114 = entityKind, _b94) {
  constructor() {
    super(...arguments);
    __publicField(this, "dimensions", this.config.dimensions);
  }
...
var _a115, _b95;
_b95 = entityKind, _a115 = Symbol.toStringTag;
var QueryPromise = class {
  constructor() {
    __publicField(this, _a115, "QueryPromise");
  }
  catch(onRejected) {
...
__publicField(QueryPromise, _b95, "QueryPromise");
...
__publicField(_SelectionProxyHandler, _a116, "SelectionProxyHandler");
var SelectionProxyHandler = _SelectionProxyHandler;

// ../node_modules/drizzle-orm/pg-core/query-builders/delete.js
var _a117, _b96;
var PgDeleteBase = class extends (_b96 = QueryPromise, _a117 = entityKind, _b96) {
...
__publicField(PgDeleteBase, _a117, "PgDelete");
...
__publicField(CasingCache, _a118, "CasingCache");

// ../node_modules/drizzle-orm/errors.js
var _a119, _b97;
var DrizzleError = class extends (_b97 = Error, _a119 = entityKind, _b97) {
...
var _a120, _b98;
var TransactionRollbackError = class extends (_b98 = DrizzleError, _a120 = entityKind, _b98) {
  constructor() {
...
var _a121, _b99, _c3, _d2, _e2, _f2;
var PgTable = class extends (_f2 = Table, _e2 = entityKind, _d2 = InlineForeignKeys, _c3 = EnableRLS, _b99 = Table.Symbol.ExtraConfigBuilder, _a121 = Table.Symbol.ExtraConfigColumns, _f2) {
  constructor() {
    super(...arguments);
    /**@internal */
...
var _a126, _b100;
var _One = class _One extends (_b100 = Relation, _a126 = entityKind, _b100) {
...
var One = _One;
var _a127, _b101;
var _Many = class _Many extends (_b101 = Relation, _a127 = entityKind, _b101) {
...
var _a128, _b102;
var PgViewBase = class extends (_b102 = View, _a128 = entityKind, _b102) {
};
...
var PgDialect = class {
  ...
  buildUpdateSet(table, set) {
    ...
    const columnNames = Object.keys(tableColumns).filter(
      (colName) => {
        var _a163;
        return set[colName] !== void 0 || ((_a163 = tableColumns[colName]) == null ? void 0 : _a163.onUpdateFn) !== void 0;
      }
    );
      ...
      if (config.columns) {
        ...
        if (selectedColumns.length > 0) {
          selectedColumns = isIncludeMode ? selectedColumns.filter((c) => {
            var _a163;
            return ((_a163 = config.columns) == null ? void 0 : _a163[c]) === true;
          }) : Object.keys(tableConfig.columns).filter((key) => !selectedColumns.includes(key));
        }
      } else {
        selectedColumns = Object.keys(tableConfig.columns);
...
__publicField(TypedQueryBuilder, _a130, "TypedQueryBuilder");
...
__publicField(PgSelectBuilder, _a131, "PgSelectBuilder");
var _a132, _b103;
var PgSelectQueryBuilderBase = class extends (_b103 = TypedQueryBuilder, _a132 = entityKind, _b103) {
  ...
  createJoin(joinType) {
    return (table, on) => {
      ...
      if (typeof tableName === "string" && ((_a163 = this.config.joins) == null ? void 0 : _a163.some((join) => join.alias === tableName))) {
...
__publicField(PgSelectQueryBuilderBase, _a132, "PgSelectQueryBuilder");
var _a133, _b104;
var PgSelectBase = class extends (_b104 = PgSelectQueryBuilderBase, _a133 = entityKind, _b104) {
  constructor() {
    super(...arguments);
    __publicField(this, "authToken");
    __publicField(this, "execute", (placeholderValues) => {
...
__publicField(PgSelectBase, _a133, "PgSelect");
...
__publicField(QueryBuilder, _a134, "PgQueryBuilder");
...
var _a136, _b105;
var PgInsertBase = class extends (_b105 = QueryPromise, _a136 = entityKind, _b105) {
...
var _a137, _b106;
var PgRefreshMaterializedView = class extends (_b106 = QueryPromise, _a137 = entityKind, _b106) {
...
var _a139, _b107;
var PgUpdateBase = class extends (_b107 = QueryPromise, _a139 = entityKind, _b107) {
...
var _a140, _b108, _c4;
var _PgCountBuilder = class _PgCountBuilder extends (_c4 = SQL, _b108 = entityKind, _a140 = Symbol.toStringTag, _c4) {
  constructor(params) {
    super(_PgCountBuilder.buildEmbeddedCount(params.source, params.filters).queryChunks);
    __publicField(this, "sql");
    __publicField(this, "token");
    __publicField(this, _a140, "PgCountBuilder");
    __publicField(this, "session");
    this.params = params;
    this.mapWith(Number);
...
var _a142, _b109;
var PgRelationalQuery = class extends (_b109 = QueryPromise, _a142 = entityKind, _b109) {
...
var _a143, _b110;
var PgRaw = class extends (_b110 = QueryPromise, _a143 = entityKind, _b110) {
...
__publicField(IndexBuilderOn, _a145, "PgIndexBuilderOn");
var _a146;
_a146 = entityKind;
...
__publicField(IndexBuilder, _a146, "PgIndexBuilder");
var _a147;
_a147 = entityKind;
var Index = class {
...
__publicField(Index, _a147, "PgIndex");
function index(name) {
...
__publicField(PgPolicy, _a148, "PgPolicy");
...
__publicField(PgRole, _a149, "PgRole");
...
__publicField(PgSequence, _a150, "PgSequence");
...
__publicField(DefaultViewBuilderCore, _a151, "PgDefaultViewBuilderCore");
var _a152, _b111;
var ViewBuilder = class extends (_b111 = DefaultViewBuilderCore, _a152 = entityKind, _b111) {
  as(qb) {
    if (typeof qb === "function") {
...
__publicField(ViewBuilder, _a152, "PgViewBuilder");
var _a153, _b112;
var ManualViewBuilder = class extends (_b112 = DefaultViewBuilderCore, _a153 = entityKind, _b112) {
...
__publicField(ManualViewBuilder, _a153, "PgManualViewBuilder");
var _a154;
_a154 = entityKind;
...
__publicField(MaterializedViewBuilderCore, _a154, "PgMaterializedViewBuilderCore");
var _a155, _b113;
var MaterializedViewBuilder = class extends (_b113 = MaterializedViewBuilderCore, _a155 = entityKind, _b113) {
  as(qb) {
    if (typeof qb === "function") {
      qb = qb(new QueryBuilder());
    }
...
__publicField(MaterializedViewBuilder, _a155, "PgMaterializedViewBuilder");
var _a156, _b114;
var ManualMaterializedViewBuilder = class extends (_b114 = MaterializedViewBuilderCore, _a156 = entityKind, _b114) {
  constructor(name, columns, schema) {
    super(name, schema);
    __publicField(this, "columns");
    this.columns = getTableColumns(pgTable(name, columns));
...
__publicField(ManualMaterializedViewBuilder, _a156, "PgManualMaterializedViewBuilder");
var _a157, _b115, _c5;
var PgView = class extends (_c5 = PgViewBase, _b115 = entityKind, _a157 = PgViewConfig, _c5) {
...
__publicField(PgView, _b115, "PgView");
var PgMaterializedViewConfig = Symbol.for("drizzle:PgMaterializedViewConfig");
var _a158, _b116, _c6;
var PgMaterializedView = class extends (_c6 = PgViewBase, _b116 = entityKind, _a158 = PgMaterializedViewConfig, _c6) {
  constructor({ pgConfig, config }) {
    super(config);
    __publicField(this, _a158);
...
__publicField(PgSchema, _a159, "PgSchema");
...
__publicField(PgPreparedQuery, _a160, "PgPreparedQuery");
var _a161;
_a161 = entityKind;
var PgSession = class {
  constructor(dialect) {
...
__publicField(PgSession, _a161, "PgSession");
var _a162, _b117;
var PgTransaction = class extends (_b117 = PgDatabase, _a162 = entityKind, _b117) {
...
__publicField(PgTransaction, _a162, "PgTransaction");
